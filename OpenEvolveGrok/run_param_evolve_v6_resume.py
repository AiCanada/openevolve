...
SEEDS = [
    {'ease': 0.0, 'hermite': 0.0, 'w_lin': 0.052664994399385164, 'w_screw': 0.4829207777412645, 'w_local': 0.38852630565387564, 'w_dom': 0.0, 'w_mode': 0.07588792220447473, 'local_half': 25, 'half_s': 2, 'half_l': 30, 'w_ms_small': 0.3820847684637362, 'w_ms_mid': 0.6098754665065091, 'w_ms_large': 0.008039765028770457, 'n_dom': 5, 'min_dom': 11, 'use_chasles': 0.05204024102425529, 'timewarp': 0.0, 's_gate': 0.18377815588726445, 'n_modes': 1, 'mode_mid_boost': 0.28368171097209927, 'bond_strength': 0.0},
    {'ease': 0.0300469580504501, 'hermite': 0.0, 'w_lin': 0.0774472002635496, 'w_screw': 0.6222878385272743, 'w_local': 0.21749761158972067, 'w_dom': 0.010151817548373455, 'w_mode': 0.07261553207008181, 'local_half': 24, 'half_s': 2, 'half_l': 27, 'w_ms_small': 0.1823344906527068, 'w_ms_mid': 0.8069964036464635, 'w_ms_large': 0.01066910569982502, 'n_dom': 4, 'min_dom': 10, 'use_chasles': 0.04409095354062464, 'timewarp': 0.12218116149035148, 's_gate': 0.17315000031206101, 'n_modes': 1, 'mode_mid_boost': 0.19266926421304761, 'bond_strength': 0.0},
    # push further local
    dict(ease=0.0, hermite=0.0, w_lin=0.04, w_screw=0.46, w_local=0.42, w_dom=0.0, w_mode=0.08,
         local_half=26, half_s=2, half_l=30, w_ms_small=0.40, w_ms_mid=0.58, w_ms_large=0.02,
         n_dom=1, min_dom=8, use_chasles=0.0, timewarp=0.0, s_gate=0.20, n_modes=1,
         mode_mid_boost=0.30, bond_strength=0.0),
    dict(ease=0.0, hermite=0.0, w_lin=0.06, w_screw=0.50, w_local=0.36, w_dom=0.0, w_mode=0.08,
         local_half=28, half_s=2, half_l=32, w_ms_small=0.35, w_ms_mid=0.63, w_ms_large=0.02,
         n_dom=1, min_dom=8, use_chasles=0.05, timewarp=0.03, s_gate=0.18, n_modes=1,
         mode_mid_boost=0.28, bond_strength=0.0),
    dict(ease=0.0, hermite=0.0, w_lin=0.08, w_screw=0.55, w_local=0.30, w_dom=0.0, w_mode=0.07,
         local_half=24, half_s=2, half_l=28, w_ms_small=0.30, w_ms_mid=0.68, w_ms_large=0.02,
         n_dom=1, min_dom=8, use_chasles=0.0, timewarp=0.0, s_gate=0.22, n_modes=1,
         mode_mid_boost=0.25, bond_strength=0.0),
    dict(ease=0.03, hermite=0.0, w_lin=0.08, w_screw=0.62, w_local=0.22, w_dom=0.0, w_mode=0.08,
         local_half=24, half_s=2, half_l=27, w_ms_small=0.18, w_ms_mid=0.80, w_ms_large=0.02,
         n_dom=1, min_dom=8, use_chasles=0.0, timewarp=0.12, s_gate=0.17, n_modes=1,
         mode_mid_boost=0.19, bond_strength=0.0),
...
def main():
    ...
    log_path = OUT / "param_evolve_v6_resume_log.jsonl"
    ...
    try:
        ...
        pass
    print(f"=== param evolve v6 RESUME 250 after 794: {args.iterations} iters device={args.device} ===", flush=True)
        ...
        for it in range(args.iterations):
            ...
            if (it + 1) % 50 == 0:
                ...
                if best_dual is not None:
                    ...
                    (OUT / "param_evolve_v6_resume_checkpoint.json").write_text(
