...
import numpy as np
PARAMS = {'ease': 0.0300469580504501, 'hermite': 0.0, 'w_lin': 0.07744720026354962, 'w_screw': 0.6222878385272744, 'w_local': 0.2174976115897207, 'w_dom': 0.010151817548373456, 'w_mode': 0.07261553207008183, 'local_half': 24, 'half_s': 2, 'half_l': 27, 'w_ms_small': 0.18233449065270765, 'w_ms_mid': 0.8069964036464673, 'w_ms_large': 0.010669105699825071, 'n_dom': 4, 'min_dom': 10, 'use_chasles': 0.056424895744468455, 'timewarp': 0.12218116149035148, 's_gate': 0.18946292580420215, 'n_modes': 1, 'mode_mid_boost': 0.19266926421304761, 'bond_strength': 0.0}
