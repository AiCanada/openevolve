...
import numpy as np
PARAMS = {'ease': 0.01656458633604745, 'hermite': 0.0, 'w_lin': 0.0, 'w_screw': 0.5925892464097408, 'w_local': 0.3331569567582794, 'w_dom': 0.0, 'w_mode': 0.07425379683099403, 'local_half': 23, 'half_s': 2, 'half_l': 24, 'w_ms_small': 0.26786389000477573, 'w_ms_mid': 0.7233670510299913, 'w_ms_large': 0.00876905896423418, 'n_dom': 4, 'min_dom': 8, 'use_chasles': 0.0, 'timewarp': 0.06589951544874657, 's_gate': 0.201760396144735, 'n_modes': 1, 'mode_mid_boost': 0.2691589688500917, 'bond_strength': 0.019438584478809258}
