...
import numpy as np
PARAMS = {'ease': 0.14118708219571147, 'hermite': 0.049025862344506406, 'w_lin': 0.07694143693462165, 'w_screw': 0.4944542602533366, 'w_local': 0.36268004424901984, 'w_dom': 0.0, 'w_mode': 0.06592425856202189, 'local_half': 32, 'half_s': 2, 'half_l': 36, 'w_ms_small': 0.36773871484696796, 'w_ms_mid': 0.5908066764646956, 'w_ms_large': 0.04145460868734009, 'n_dom': 2, 'min_dom': 7, 'use_chasles': 0.004501034549267754, 'timewarp': 0.01248845656570139, 's_gate': 0.07549482534186869, 'n_modes': 1, 'mode_mid_boost': 0.24922512185593557, 'bond_strength': 0.0}
