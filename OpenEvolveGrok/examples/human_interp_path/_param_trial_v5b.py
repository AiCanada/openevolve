...
import numpy as np
PARAMS = {'ease': 0.0300469580504501, 'hermite': 0.0, 'w_lin': 0.07784790239130708, 'w_screw': 0.5928346473936158, 'w_local': 0.21862291702942147, 'w_dom': 0.03770329743377714, 'w_mode': 0.07299123575090831, 'local_half': 21, 'half_s': 2, 'half_l': 22, 'w_ms_small': 0.20433623558456918, 'w_ms_mid': 0.7853422194262291, 'w_ms_large': 0.010321544988229712, 'n_dom': 4, 'min_dom': 8, 'use_chasles': 0.04409095354062464, 'timewarp': 0.13862677273577884, 's_gate': 0.17315000031206101, 'n_modes': 1, 'mode_mid_boost': 0.19218693626673472, 'bond_strength': 0.0}
