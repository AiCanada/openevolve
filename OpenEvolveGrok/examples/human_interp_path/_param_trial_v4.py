...
import numpy as np
PARAMS = {'ease': 0, 'hermite': 0, 'w_lin': 0.12212212212199988, 'w_screw': 0.6756756756749994, 'w_local': 0.14514514514499985, 'w_dom': 0.0, 'w_mode': 0.05705705705699995, 'local_half': 13, 'half_s': 5, 'half_l': 22, 'w_ms_small': 0.0, 'w_ms_mid': 0.9999999999989999, 'w_ms_large': 0.0, 'n_dom': 3, 'min_dom': 8, 'use_chasles': 0.0, 'timewarp': 0.0, 's_gate': 0.0, 'n_modes': 1, 'mode_mid_boost': 0.113, 'bond_strength': 0}
