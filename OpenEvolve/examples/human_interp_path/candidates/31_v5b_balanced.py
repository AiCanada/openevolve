...
import numpy as np
PARAMS = {'ease': 0.0300469580504501, 'hermite': 0.0, 'w_lin': 0.0802465730245495, 'w_screw': 0.6111012289634551, 'w_local': 0.22535918550581946, 'w_dom': 0.008052751047708102, 'w_mode': 0.07524026145746773, 'local_half': 21, 'half_s': 2, 'half_l': 22, 'w_ms_small': 0.181465109912398, 'w_ms_mid': 0.807916655261373, 'w_ms_large': 0.010618234825211322, 'n_dom': 4, 'min_dom': 9, 'use_chasles': 0.04409095354062464, 'timewarp': 0.11652009267927878, 's_gate': 0.17315000031206101, 'n_modes': 1, 'mode_mid_boost': 0.19218693626673472, 'bond_strength': 0.0}
