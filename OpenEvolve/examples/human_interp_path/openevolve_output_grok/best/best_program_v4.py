...
import numpy as np
PARAMS = {'ease': 0, 'hermite': 0, 'w_lin': 0.122, 'w_screw': 0.675, 'w_local': 0.145, 'w_dom': 0.0, 'w_mode': 0.057, 'local_half': 13, 'half_s': 5, 'half_l': 22, 'w_ms_small': 0.0, 'w_ms_mid': 1.0, 'w_ms_large': 0.0, 'n_dom': 3, 'min_dom': 8, 'use_chasles': 0.0, 'timewarp': 0.0, 's_gate': 0.0, 'n_modes': 1, 'mode_mid_boost': 0.113, 'bond_strength': 0}
