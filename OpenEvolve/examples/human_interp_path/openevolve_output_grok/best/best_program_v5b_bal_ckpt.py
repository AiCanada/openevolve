...
import numpy as np
PARAMS = {'ease': 0.03519813946211915, 'hermite': 0.032851861846629096, 'w_lin': 0.06304857876942373, 'w_screw': 0.6445475845551479, 'w_local': 0.16707710121873987, 'w_dom': 0.0, 'w_mode': 0.12532673545568854, 'local_half': 19, 'half_s': 2, 'half_l': 20, 'w_ms_small': 0.15373750870297337, 'w_ms_mid': 0.8367377964465604, 'w_ms_large': 0.009524694849490385, 'n_dom': 1, 'min_dom': 9, 'use_chasles': 0.0, 'timewarp': 0.0, 's_gate': 0.14743748266883822, 'n_modes': 1, 'mode_mid_boost': 0.11210167664017417, 'bond_strength': 0}
