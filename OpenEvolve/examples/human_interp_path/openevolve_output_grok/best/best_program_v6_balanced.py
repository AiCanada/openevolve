...
import numpy as np
PARAMS = {'ease': 0.14324942113249264, 'hermite': 0.059022665775652905, 'w_lin': 0.03369241154320932, 'w_screw': 0.49998862472710665, 'w_local': 0.4147807875459672, 'w_dom': 0.0, 'w_mode': 0.05153817618270478, 'local_half': 25, 'half_s': 2, 'half_l': 36, 'w_ms_small': 0.5299984862219004, 'w_ms_mid': 0.4280172482711877, 'w_ms_large': 0.04198426550591202, 'n_dom': 1, 'min_dom': 10, 'use_chasles': 0.006370318953902556, 'timewarp': 0.00629149604588762, 's_gate': 0.0985531787266622, 'n_modes': 1, 'mode_mid_boost': 0.2679192325718954, 'bond_strength': 0.0}
