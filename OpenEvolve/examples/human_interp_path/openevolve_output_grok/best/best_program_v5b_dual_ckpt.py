...
import numpy as np
PARAMS = {'ease': 0.0, 'hermite': 0.025231308554455045, 'w_lin': 0.06221222333153945, 'w_screw': 0.622990871408861, 'w_local': 0.1936616873115169, 'w_dom': 0.0, 'w_mode': 0.12113521794710387, 'local_half': 19, 'half_s': 2, 'half_l': 23, 'w_ms_small': 0.1582713619645264, 'w_ms_mid': 0.8319230516239519, 'w_ms_large': 0.009805586410521802, 'n_dom': 1, 'min_dom': 6, 'use_chasles': 0.0, 'timewarp': 0.0, 's_gate': 0.14072003357924948, 'n_modes': 1, 'mode_mid_boost': 0.1647995261692021, 'bond_strength': 0.0529542454090391}
