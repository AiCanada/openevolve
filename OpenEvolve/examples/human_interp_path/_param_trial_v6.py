...
import numpy as np
PARAMS = {'ease': 0.14197890234079205, 'hermite': 0.11370771013186731, 'w_lin': 0.05471703032739539, 'w_screw': 0.3889218955523097, 'w_local': 0.4489436579535165, 'w_dom': 0.04320915593297041, 'w_mode': 0.06420826023280803, 'local_half': 28, 'half_s': 2, 'half_l': 36, 'w_ms_small': 0.5647020814233711, 'w_ms_mid': 0.4352979185756568, 'w_ms_large': 0.0, 'n_dom': 1, 'min_dom': 9, 'use_chasles': 0.03208794483283199, 'timewarp': 0.0, 's_gate': 0.01738954998526276, 'n_modes': 1, 'mode_mid_boost': 0.3200525107674993, 'bond_strength': 0.0}
