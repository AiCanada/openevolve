...
SEEDS = [
    {'ease': 0.14197890234079205, 'hermite': 0.11370771013186731, 'w_lin': 0.05581865274476874, 'w_screw': 0.3967520916756043, 'w_local': 0.4603490899681316, 'w_dom': 0.02157919525746088, 'w_mode': 0.06550097035303522, 'local_half': 29, 'half_s': 2, 'half_l': 36, 'w_ms_small': 0.5922909188171647, 'w_ms_mid': 0.4077090811818036, 'w_ms_large': 0.0, 'n_dom': 1, 'min_dom': 7, 'use_chasles': 0.04529782525079128, 'timewarp': 0.010117711103918034, 's_gate': 0.001999113056379582, 'n_modes': 1, 'mode_mid_boost': 0.2895873764860074, 'bond_strength': 0.0},
    {'ease': 0.14324942113249264, 'hermite': 0.059022665775652905, 'w_lin': 0.03369241154320932, 'w_screw': 0.49998862472710665, 'w_local': 0.4147807875459672, 'w_dom': 0.0, 'w_mode': 0.05153817618270478, 'local_half': 25, 'half_s': 2, 'half_l': 36, 'w_ms_small': 0.5299984862219004, 'w_ms_mid': 0.4280172482711877, 'w_ms_large': 0.04198426550591202, 'n_dom': 1, 'min_dom': 10, 'use_chasles': 0.006370318953902556, 'timewarp': 0.00629149604588762, 's_gate': 0.0985531787266622, 'n_modes': 1, 'mode_mid_boost': 0.2679192325718954, 'bond_strength': 0.0},
    dict(ease=0.0, hermite=0.0, w_lin=0.04, w_screw=0.47, w_local=0.40, w_dom=0.0, w_mode=0.09,
         local_half=32, half_s=2, half_l=36, w_ms_small=0.42, w_ms_mid=0.56, w_ms_large=0.02,
         n_dom=2, min_dom=7, use_chasles=0.0, timewarp=0.03, s_gate=0.08, n_modes=1,
...
def main():
    ...
    log_path = OUT / "param_evolve_v6_resume3_log.jsonl"
        ...
        for it in range(args.iterations):
            ...
            if (it + 1) % 50 == 0:
                ...
                if best_dual is not None:
                    ...
                    (OUT / "param_evolve_v6_resume3_checkpoint.json").write_text(
    ...
    if promo is not None:
        ...
        (OUT / "param_evolve_v6_resume3_summary.json").write_text(json.dumps(info, indent=2), encoding="utf-8")
