...
import numpy as np
PARAMS = {'ease': 0.0, 'hermite': 0.0, 'w_lin': 0.05329040798690044, 'w_screw': 0.47678029723595206, 'w_local': 0.39314017931766704, 'w_dom': 0.0, 'w_mode': 0.07678911545848056, 'local_half': 25, 'half_s': 2, 'half_l': 30, 'w_ms_small': 0.38353545571262065, 'w_ms_mid': 0.6085827699244107, 'w_ms_large': 0.00788177436196869, 'n_dom': 5, 'min_dom': 13, 'use_chasles': 0.04174064765564398, 'timewarp': 0.0, 's_gate': 0.17814465888911493, 'n_modes': 1, 'mode_mid_boost': 0.28368171097209927, 'bond_strength': 0.0}
